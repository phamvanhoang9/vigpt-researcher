...
from sys import platform # platform is used to check the OS of the user

from bs4 import BeautifulSoup
from selenium import webdriver # selenium is used to scrape the web
from selenium.webdriver.chrome.options import Options as ChromeOptions # ChromeOptions is used to set the options for the Chrome browser
from selenium.webdriver.common.by import By # By is used to select the element by the type of the element
...
from selenium.webdriver.support import expected_conditions as EC # EC is used to set the conditions for the browser
from selenium.webdriver.support.wait import WebDriverWait # WebDriverWait is used to wait for the element to load
from fastapi import WebSocket # WebSocket is used to communicate with the client
...
from concurrent.futures import ThreadPoolExecutor # ThreadPoolExecutor is used to run the function in a separate thread

from scraping.processing.text import summarize_text

executor = ThreadPoolExecutor()

FILE_DIR = Path(__file__).parent.parent # FILE_DIR is used to get the parent directory of the current file
